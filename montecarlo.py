...
#     init_guess = (3,0,0.8)
#     for i in range(int(numSim/50)):
#         jobs = []
#         test_data_1 = []
#         mC_1 = []
#         for proc in range(50):
...
# #     #Second Set of Data 
    ...
    #         # Simulate the time series:      
    #         test_data_1.append(sim_1.simulation(-0.6, sim_length = 200))
    #         mC_1.append(MonteCarlo(numSim= 5, model = OpinionFormation , estimation= estimation.Estimation(test_data_1[proc],multiprocess= False,model_type=0), real_data= False))
    #         p = mp.Process(target=mC_1[proc].run, args= (tuple(init_guess),))
    #         jobs.append(p)
    #         p.start()
...
# #     # # #Third Set of Data 
    ...
    init_guess = (3,0,1.2)
    for i in range(int(numSim/25)):
        jobs = []
        test_data_3 = []
        mC_3 = []
        for proc in range(25):
            # Simulate the time series:      
