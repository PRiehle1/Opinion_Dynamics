...
test = model.OpinionFormation(N = 175, T = 30, nu = 0.08 , alpha0 = 0.0, alpha1 = 1.2,alpha2 = None,alpha3 = None, y = None, deltax = 0.01, deltat = 1/16, model_type =0) #

test_1 = model.OpinionFormation(N = 175, T = 30, nu = 0.8 , alpha0 = 0.0, alpha1 = 1.2,alpha2 = None,alpha3 = None, y = None, deltax = 0.01, deltat = 1/16, model_type =0) 
...
area,prob,prob_end = test.CrankNicolson(x_0 = 0,check_stability = True, calc_dens = True, converged =  False, fast_comp = False)
