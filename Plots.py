...
def plot_figures() -> None:
    """
    It plots the figures in the paper.
    """
    ##########################################################################################################
    #                                          Figure 1                                                      #
    ##########################################################################################################
    ...
    #                                          Figure 5                                                     #
    ##########################################################################################################
    month = pd.date_range('1991-12-01','2022-04-30', freq='MS').strftime("%Y-%b").tolist()

    data_1 = data_reader(time_start= 0, time_end= 365)
    zew = data_1.zew()/100
    ...
    model_0_set_3_data[model_0_set_3_data > 1] = 1
    ...
    model_2_set_3_data[model_2_set_3_data > 1] = 1
    ...
    model_0_set_3_data_mean = np.zeros(model_0_set_3_data.shape[1])
    model_0_set_3_data_lb = np.zeros(model_0_set_3_data.shape[1])
    model_0_set_3_data_ub = np.zeros(model_0_set_3_data.shape[1])

    model_2_set_3_data_mean = np.zeros(model_2_set_3_data.shape[1])
    model_2_set_3_data_lb = np.zeros(model_2_set_3_data.shape[1])
    model_2_set_3_data_ub = np.zeros(model_2_set_3_data.shape[1])

    model_3_set_3_data_mean = np.zeros(model_3_set_3_data.shape[1])
    model_3_set_3_data_lb = np.zeros(model_3_set_3_data.shape[1])
    model_3_set_3_data_ub = np.zeros(model_3_set_3_data.shape[1])

    model_6_set_3_data_mean = np.zeros(model_6_set_3_data.shape[1])
    model_6_set_3_data_lb = np.zeros(model_6_set_3_data.shape[1])
    model_6_set_3_data_ub = np.zeros(model_6_set_3_data.shape[1])


    for i in range(0,model_3_set_3_data.shape[1]):
        model_3_set_3_data_mean[i] = np.mean(model_3_set_3_data[:,i])
        model_3_set_3_data_lb[i], model_3_set_3_data_ub[i] = norm.interval(0.95, loc=np.mean(model_3_set_3_data[:,i]) , scale=np.std(model_3_set_3_data[:,i] ))

        model_2_set_3_data_mean[i] = np.mean(model_2_set_3_data[:,i])
        model_2_set_3_data_lb[i], model_2_set_3_data_ub[i] = norm.interval(0.95, loc=np.mean(model_2_set_3_data[:,i]) , scale=np.std(model_2_set_3_data[:,i] ))

        model_0_set_3_data_mean[i] = np.mean(model_0_set_3_data[:,i])
        model_0_set_3_data_lb[i], model_0_set_3_data_ub[i] = norm.interval(0.95, loc=np.mean(model_0_set_3_data[:,i]) , scale=np.std(model_0_set_3_data[:,i] ))

        model_6_set_3_data_mean[i] = np.mean(model_6_set_3_data[:,i])
        model_6_set_3_data_lb[i], model_6_set_3_data_ub[i] = norm.interval(0.95, loc=np.mean(model_6_set_3_data[:,i]) , scale=np.std(model_6_set_3_data[:,i] ))

    fig, axs = plt.subplots(2,2)

    axs[0,0].plot(month[0:365],model_0_set_3_data_ub,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[0,0].plot(month[0:365],model_0_set_3_data_lb,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[0,0].plot(month[0:365],model_0_set_3_data[403, :], color = "silver")
    axs[0,0].plot(zew, color = "black", linestyle = "solid")
    axs[0,0].set_ylabel("x")
    axs[0,0].set_xlabel("Time")
    axs[0,0].set_xticks([0,109,169+60,169+180],rotation=0)
    axs[0,0].text(0.5,1.1, "(a) Model 0", size=10, ha="center", 
            transform=axs[0,0].transAxes)

    axs[0,1].plot(month[0:365],model_2_set_3_data_ub,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[0,1].plot(month[0:365],model_2_set_3_data_lb,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[0,1].plot(month[0:365],model_2_set_3_data[103, :], color = "silver")
    axs[0,1].plot(zew, color = "black", linestyle = "solid")
    axs[0,1].set_ylabel("x")
    axs[0,1].set_xlabel("Time")
    axs[0,1].set_xticks([0,109,169+60,169+180],rotation=0)
    axs[0,1].text(0.5,1.1, "(b) Model 2", size=10, ha="center", 
            transform=axs[0,1].transAxes)

    axs[1,0].plot(month[0:365],model_3_set_3_data_ub,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[1,0].plot(month[0:365],model_3_set_3_data_lb,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[1,0].plot(month[0:365],model_3_set_3_data[705, :], color = "silver")
    axs[1,0].plot(zew, color = "black", linestyle = "solid")
    axs[1,0].set_ylabel("x")
    axs[1,0].set_xlabel("Time")
    axs[1,0].set_xticks([0,109,169+60,169+180],rotation=0)
    axs[1,0].text(0.5,1.1, "(c) Model 4", size=10, ha="center", 
            transform=axs[1,0].transAxes)

    axs[1,1].plot(month[0:365],model_6_set_3_data_ub,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[1,1].plot(month[0:365],model_6_set_3_data_lb,color = "black",linestyle=(0, (3, 1, 1, 1)))
    axs[1,1].plot(month[0:365],model_6_set_3_data[363, :], color = "silver")
    axs[1,1].plot(zew, color = "black", linestyle = "solid")
    axs[1,1].set_ylabel("x")
    axs[1,1].set_xlabel("Time")
    axs[1,1].set_xticks([0,109,169+60,169+180],rotation=0)
    axs[1,1].text(0.5,1.1, "(d) Model 6", size=10, ha="center", 
...
# fig.tight_layout()
# fig.set_size_inches(9, 4)
# plt.savefig('Figure_D_1.png', dpi=600,bbox_inches='tight')
# plt.show()
